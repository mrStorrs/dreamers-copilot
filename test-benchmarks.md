...
|---|---|---|---|---|
| `python3 -m py_compile .github/dreamers/scripts/dreamers_stats.py` | 0.04s | 2026-06-13 | 30s | Syntax validation for the stats writer. |
| `python3 -m unittest tests/test_dreamers_stats.py` | 0.26s | 2026-06-13 | 30s | 30s floor. |
