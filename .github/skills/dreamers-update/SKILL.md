...
4. **dreamers-implement mirror.** Edits to `dreamers-implement` flow (test-writing, type-check, apply-findings, user-testing gate) must be mirrored in Copilot `.github/skills/dreamers/SKILL.md` and Codex `skills/dreamers/SKILL.md`.
