...
Visual map of every decision point in the end-to-end pipeline. Source of truth is `SKILL.md`; this is the picture. Task mode runs Phase 1 discovery/full-spec planning and Phase 1.5. Plan path and manifest modes skip Phase 1.5 and start implementation after artifact + plan-quality checks.
...
flowchart TD
    ...
    P1 --> InvokePlan["Invoke /dreamers-plan<br/>discovery + full-spec plans"]
...
- Task mode invokes `/dreamers-plan`, which performs a codebase-informed discovery interview and writes full-spec plans with architecture, files touched, contracts, ACs, constraints, and verification.
