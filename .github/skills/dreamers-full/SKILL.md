...
5. **User-testing-required check** — if the sub-plan's `User testing required: yes`, distribute a build per the project distribution method (see `.github/copilot-instructions.md` Distribution section), notify user, **pause** until explicit go-ahead.
